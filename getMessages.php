...
$sqlNewMessages="select count(messages.id) as count from messages where messages.chatid=? and messages.id>?";
$stmt = $mysqli->prepare($sqlNewMessages);
